...
import { Star, Zap, Settings, Search, Filter } from "lucide-react"
  ...
  const products = [
    {
      ...
      features: ["Haute performance", "Bobine AC/DC", "Contacts auxiliaires"],
      badge: "Professionnel",
    },
    {
      name: "Relais thermique RTX³",
      series: "RTX³",
      power: "0.1-32A",
      price: "Sur devis",
      rating: 5,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Protection moteur", "Réglage précis", "Signalisation LED"],
      badge: "Protection",
    },
    {
      name: "Démarreur CTX³",
      ...
      rating: 4,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Démarrage moteur", "Protection intégrée", "Compact"],
      badge: "Compact",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <span className="text-2xl font-bold text-emh-black">Solutions Industrielles</span>
            </div>
            <h1 className="text-5xl font-bold text-emh-black mb-6">
              Gamme <span className="text-emh-red">Industrielle</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Contacteurs, relais et démarreurs Legrand CTX³. Solutions robustes et fiables pour vos applications
                ...
                <CardContent className="p-0">
                  <div className="relative h-48 bg-emh-gray">
                    ...
                    <div className="absolute top-4 right-4 bg-white rounded-full p-2">
                      <Settings className="h-4 w-4 text-emh-red" />
                    </div>
                  </div>
                  <div className="p-6">

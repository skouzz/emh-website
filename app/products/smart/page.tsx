...
import { Star, Smartphone, Wifi, Search, Filter } from "lucide-react"
...
export default function SmartProductsPage() {
  ...
  const products = [
    ...
    },
    {
      ...
      rating: 5,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Contrôle vocal", "Programmation", "Design premium"],
      badge: "Premium",
    },
    {
      ...
      rating: 4,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Contrôle température", "Économies d'énergie", "Programmable"],
      badge: "Économique",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <span className="text-2xl font-bold text-emh-black">Domotique Connectée</span>
            </div>
            <h1 className="text-5xl font-bold text-emh-black mb-6">
              Solutions <span className="text-emh-red">Smart</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Découvrez les solutions domotiques Legrand : MyHOME, Céliane with Netatmo. Contrôlez votre maison depuis
              votre smartphone.
            </p>
          </div>
        </div>
                ...
                <CardContent className="p-0">
                  <div className="relative h-48 bg-emh-gray">
                    ...
                    <div className="absolute top-4 right-4 bg-white rounded-full p-2">
                      <Wifi className="h-4 w-4 text-emh-red" />
                    </div>
                  </div>
                  <div className="p-6">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <Smartphone className="h-4 w-4 text-emh-red" />
                      <span className="text-sm font-medium text-gray-700">Contrôle mobile</span>
                    </div>

  ...
  const products = [
    {
      ...
      features: ["Finition métal", "Design premium", "Compatible domotique"],
      badge: "Premium",
    },
    {
      name: "Céliane Blanc",
      ...
      rating: 5,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Finition laquée", "Éclairage LED", "Modulaire"],
      badge: "Bestseller",
    },
    {
      name: "Mosaic 2 modules",
      series: "Mosaic",
      price: "Sur devis",
      rating: 4,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Modulaire", "Évolutif", "Économique"],
      badge: "Modulaire",
    },
    {
      name: "Niloe Simple",
      ...
      rating: 4,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Économique", "Fiable", "Installation facile"],
      badge: "Économique",
    },
    {
      ...
      rating: 5,
      image: "/placeholder.svg?height=200&width=200",
      features: ["2 ports USB", "Charge rapide", "Design moderne"],
      badge: "Smart",
    },
    {
      ...
      rating: 5,
      image: "/placeholder.svg?height=200&width=200",
      features: ["Variation LED", "Télécommande", "Programmable"],
      badge: "Intelligent",
    },
  ]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <span className="text-2xl font-bold text-emh-black">Interrupteurs & Prises</span>
            </div>
            <h1 className="text-5xl font-bold text-emh-black mb-6">
              Gamme <span className="text-emh-red">Complète</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Découvrez notre sélection d'interrupteurs et prises Legrand : Céliane, Mosaic, Niloe. Design, qualité et
              innovation pour tous vos projets.
            </p>
          </div>
              ...
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                <CardContent className="p-0">
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-emh-black mb-3">{product.name}</h3>
